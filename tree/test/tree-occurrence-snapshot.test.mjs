...
test('tree occurrence snapshot preserves deterministic lineage and depth', () => {
  const snapshot = prepareTreeOccurrenceSnapshot({
    selectedPaths: ['calculogic-validator/tree/src/registries/tree-structural-homes-registry.logic.mjs'],
    targets: [],
    includeRoots: ['calculogic-validator'],
  });
  ...
  assert.equal(
    recordsByPath['calculogic-validator/tree/src/registries/tree-structural-homes-registry.logic.mjs'].parentResolvedPath,
