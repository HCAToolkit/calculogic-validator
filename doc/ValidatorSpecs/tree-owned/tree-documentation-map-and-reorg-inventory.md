...
| `calculogic-validator/doc/ValidatorSpecs/tree-owned/tree-addressed-occurrence-registry-source-audit.md` | Tree addressed-occurrence registry-source audit documenting verified built-in registry surfaces, runtime consumers, ownership boundaries, gaps, and the next narrow registry-backed seam for issue #668 | **Audit** | Architecture/modeling, addressed-occurrence adapter planning, Codex task setup context | **Stay put** under `ValidatorSpecs/tree-owned` for tree-owned discoverability | **Keep** |
